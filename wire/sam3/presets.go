...
// I2CP presets
var (
	hugeShuffle = []string{"inbound.length=3", "outbound.length=3",
	...
	largeShuffle = []string{"inbound.length=3", "outbound.length=3",
		"inbound.lengthVariance=1", "outbound.lengthVariance=1",
	...
	noShuffle = []string{"inbound.length=0", "outbound.length=0",
