...
import (
	...
	"github.com/toghrulmaharramov/dusk-go/ec/ed25519/internal/edwards25519"
)
...
func TestGolden(t *testing.T) {
	// sign.input.txt is a selection of test cases from
	// https://github.com/hyperledger/iroha-ed25519/tree/master/test/ed25519
	testDataZ, err := os.Open("testdata/sign.input.txt")
	if err != nil {
		t.Fatal(err)
	}
	defer testDataZ.Close()

	scanner := bufio.NewScanner(testDataZ)
	lineNo := 0
