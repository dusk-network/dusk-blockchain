...
func NewReader(lpeerInfo encoding.PeerInfo, publisher eventbus.Publisher, gossip *protocol.Gossip, dupeMap *dupemap.DupeMap, processor *peer.MessageProcessor) *Reader {
	...
	r := new(Reader)
	r.base = newBaseReader(lpeerInfo, publisher, gossip, dupeMap, processor)
	r.listener = l
