...
var commandInfo = map[string]string{
	...
	Bid a given amount of DUSK, to allow participation as a block generator in consensus. Fee is optional, wil use standard value if not specified.`,
	"startconsensus": `Usage: startconsensus
	Send a signal to the connected DUSK node to start participating in consensus.`,
	"exit": nil,
	"quit": nil,
}
