...
test-harness-tps: stop build
	MOCK_ADDRESS=127.0.0.1:9191 DUSK_BLOCKCHAIN=${PWD}/bin/dusk DUSK_UTILS=${PWD}/bin/utils DUSK_SEEDER=${PWD}/bin/voucher DUSK_CONSENSUS_KEYS_PASS="password" RUSK_PATH=${PWD}/bin/rusk \
